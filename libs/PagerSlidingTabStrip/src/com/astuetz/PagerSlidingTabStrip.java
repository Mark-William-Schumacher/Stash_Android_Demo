...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private void addTextTab(final int position, String title) {
		...
		addTab(position, getResources().getDrawable(R.drawable.backpack) );
	}

	private void addIconTab(final int position, Drawable drawable) {
		addTab(position, drawable);
	}

	private void addTab(final int position, Drawable drawable) {
		LayoutInflater li = LayoutInflater.from(getContext());
		View v  = li.inflate(R.layout.tab,tabsContainer,false);
		ImageView tab = (ImageView) v.findViewById(R.id.icontab);
		...
		tabsContainer.addView(v, position, shouldExpand ? expandedTabLayoutParams : defaultTabLayoutParams);
	}
